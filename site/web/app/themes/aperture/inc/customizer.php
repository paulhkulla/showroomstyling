...
function aperture_custom_colors() {
	$css 				= '';
	$text_color 		= get_theme_mod( 'aperture_text_color', '#000000' );
	$link_color 		= get_theme_mod( 'aperture_link_color', '#D4AF37' );
	$background_color 	= get_theme_mod( 'aperture_content_background_color', '#ffffff' );
